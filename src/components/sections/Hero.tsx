                ...
                >
                    ...
                    <div className="pt-8 text-left">
                        <Button
                            ...
                            size="lg"
                            className="h-16 md:h-24 w-full md:w-auto rounded-none px-8 md:px-16 text-base md:text-2xl font-black uppercase tracking-[0.3em] bg-white hover:bg-white/90 text-black transition-all group shrink-0"
                        >
                            Initiate Blueprint
