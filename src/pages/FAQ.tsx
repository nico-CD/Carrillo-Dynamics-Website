            ...
            <main className="pt-32 pb-24 px-6 max-w-4xl mx-auto w-full">
                <motion.div {...revealProps} className="space-y-16">
                    <div className="space-y-4">
                        <h1 className="text-4xl sm:text-7xl md:text-9xl font-black uppercase tracking-tighter leading-[0.85] text-foreground transition-colors break-words text-balance">
