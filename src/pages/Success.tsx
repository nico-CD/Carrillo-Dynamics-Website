...
const Success = () => {
    ...
    return (
        <div className="min-h-screen bg-[#050505] flex items-center justify-center px-6">
            <div className="max-w-xl w-full space-y-12 text-center">
                ...
                >
                    <div className="h-24 w-24 rounded-none border border-zinc-700 bg-white/[0.02] flex items-center justify-center relative">
                        ...
                        <div className="absolute inset-0 bg-[#10b981]/10 blur-xl" />
                    </div>
                </motion.div>
                ...
                <div className="space-y-6">
                    ...
                    <p className="tech-mono text-xs font-black text-zinc-400 uppercase tracking-widest leading-relaxed">
                        Technical Intake form coming soon. Our team is preparing your environment.
                    </p>
                </div>
            ...
            {/* Grid Pattern */}
            <div className="absolute inset-0 z-0 opacity-[0.03] pointer-events-none bg-[linear-gradient(to_right,#fff_1px,transparent_1px),linear-gradient(to_bottom,#fff_1px,transparent_1px)] bg-[size:64px_64px]" />
        </div>
    );
};
